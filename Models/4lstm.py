...
model = tf.keras.Sequential([
    ...
    tf.keras.layers.Bidirectional(tf.keras.layers.LSTM(32, return_sequences=True)),  # Additional LSTM layer
    tf.keras.layers.Bidirectional(tf.keras.layers.LSTM(32)),  # No return_sequences as this is the last LSTM
